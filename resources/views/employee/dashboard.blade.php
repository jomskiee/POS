...
<div class="min-h-screen bg-gray-50 flex" x-data="{ sidebarOpen: true }">
    ...
    <div :class="sidebarOpen ? 'w-64' : 'w-16'" class="bg-white min-h-screen shadow-lg transition-all duration-300 ease-in-out overflow-hidden">
        ...
        <!-- Navigation -->
        <nav class="mt-6">
            <div class="px-4 pb-2" x-show="sidebarOpen" x-transition class="px-4 pb-2">
                ...
                <li>
                    <a href="#" 
                       ...
                       @mouseleave="tooltip = false">
                        ...
                        <span x-show="sidebarOpen" x-transition class="px-4 pb-2" class="whitespace-nowrap">POS Terminal</span>
                ...
                <li>
                    <a href="#" 
                       ...
                       @mouseleave="tooltip = false">
                        ...
                        <span x-show="sidebarOpen" x-transition class="px-4 pb-2" class="whitespace-nowrap">My Transactions</span>
                ...
                <li>
                    <a href="#" 
                       ...
                       @mouseleave="tooltip = false">
                        ...
                        <span x-show="sidebarOpen" x-transition class="px-4 pb-2" class="whitespace-nowrap">My Collections</span>

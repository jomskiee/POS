    ...
    <div id="sidebar" class="bg-white w-64 min-h-screen shadow-lg transition-all duration-300 ease-in-out">
        <div class="p-4 border-b">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-xl font-bold text-gray-800">Point of Sale</span>
            </div>
        </div>
        ...
        <nav class="mt-6">
            ...
            <ul class="space-y-1 px-3">
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md text-blue-600 bg-blue-50">
